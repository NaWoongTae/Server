...
{
	S_BroadcaseEnterGame = 1,
	C_LeaveGame = 2,
	S_BroadcaseLeaveGame = 3,
	S_PlayerList = 4,
	C_Move = 5,
	S_BroadcaseMove = 6,
}
...
public class S_BroadcaseEnterGame : IPacket
{
    ...
    public ushort Protocol { get => (ushort)PacketID.S_BroadcaseEnterGame; }
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcaseEnterGame), 0, segment.Array, segment.Offset + count, sizeof(ushort));
        count += sizeof(ushort);
...
public class C_LeaveGame : IPacket
{
    ...
    public ushort Protocol { get => (ushort)PacketID.C_LeaveGame; }
...
public class S_BroadcaseLeaveGame : IPacket
{
    public int playerId;

    public ushort Protocol { get => (ushort)PacketID.S_BroadcaseLeaveGame; }
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcaseLeaveGame), 0, segment.Array, segment.Offset + count, sizeof(ushort));
        count += sizeof(ushort);
...
public class S_PlayerList : IPacket
{
    ...
    public ushort Protocol { get => (ushort)PacketID.S_PlayerList; }
...
public class C_Move : IPacket
{
    ...
    public ushort Protocol { get => (ushort)PacketID.C_Move; }
...
public class S_BroadcaseMove : IPacket
{
    public int playerId;
	public float posX;
	public float posY;
    ...
    public ushort Protocol { get => (ushort)PacketID.S_BroadcaseMove; }
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcaseMove), 0, segment.Array, segment.Offset + count, sizeof(ushort));
        count += sizeof(ushort);
